...
CREATE TABLE public.image_catalog (
  id text PRIMARY KEY,              -- e.g., 'rando1', 'rando2'
  url text NOT NULL,                -- public https URL
  weight int NOT NULL DEFAULT 1,
  is_active boolean NOT NULL DEFAULT true,
  theme text                        -- optional ('rando', etc.)
);
...
('fortune_1', '/assets/cookies/Fortune Cookie 1.png', 1, 'fortune'),
('fortune_2', '/assets/cookies/Fortune Cookie 2.png', 1, 'fortune');
